...
data STAT1.spending2011;
    input @1 Spend2011 5. @7 State $;
    datalines;
15849 Wyoming
11774 Wisconsin
11846 West Virginia
...
data STAT1.sat2013;
    input @1 CombinedSAT2013 4. @6 Participation2013 4.2 @11 State $ ;
    datalines;
1807 0.05 Illinois
1799 0.02 North Dakota
1782 0.04 Michigan
1780 0.06 Minnesota
1773 0.04 Missouri
1771 0.04 Wisconsin
1763 0.03 Iowa
1760 0.03 South Dakota
1757 0.04 Wyoming
1752 0.06 Kansas
1741 0.05 Kentucky
1734 0.04 Nebraska
...
1689 0.05 Oklahoma
1684 0.06 Utah
1673 0.03 Mississippi
1655 0.05 Louisiana
1635 0.17 Ohio
1626 0.12 New Mexico
1608 0.07 Alabama
1595 0.25 Montana
1567 0.70 New Hampshire
1553 0.83 Massachusetts
1551 0.35 Arizona
1540 0.61 Vermont
1539 0.49 Oregon
1537 0.60 Washington
1532 0.85 Connecticut
1528 0.71 Virginia
1521 0.78 New Jersey
1513 0.15 West Virginia
1505 0.57 California
1495 0.52 Alaska
1483 0.73 Maryland
1480 0.71 Pennsylvania
1479 0.62 North Carolina
1470 0.70 Indiana
1468 0.72 Rhode Island
1463 0.76 New York
1457 0.67 Florida
1454 0.48 Nevada
1453 0.64 Hawaii
1452 0.75 Georgia
1437 0.59 Texas
1436 0.64 South Carolina
1400 0.91 District of Columbia
1380 0.95 Maine
1364 0.99 Idaho
1351 1.00 Delaware
;
...
proc sort data=STAT1.Sat2013;
	by State;
run;

proc sort data=STAT1.Spending2011;
	by State;
run;

data STAT1.SAT;
	merge  STAT1.Spending2011 STAT1.Sat2013;
	by State;
run;
