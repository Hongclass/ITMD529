...
proc gplot data=g&i;
plot x2*date=_type_/cframe=cyan;
plot x3*date=_type_/cframe=pink;
plot x4*date=_type_/cframe=yellow;
plot x5*date=_type_/cframe=orange;
plot x6*date=_type_/cframe=cyan;
plot x7*date=_type_/cframe=pink;
plot x8*date=_type_/cframe=yellow;
