%let d1=fjc.gjxuexiao0;
%let d2=fjc.gjxuexiao0;
%let d3=fjc.gjxuexiao0;
%let d4=fjc.gjxuexiao0;
%let d5=fjc.gjxuexiao0;
%let d6=fjc.gjxuexiao0;
%let d7=fjc.gjxuexiao0;
%let y1=x1;
%let y2=x2;
%let y3=x3;
%let y4=x4;
...
%let x3=date x1 x2 x4 x5 x6 x7;
%let x4=date x1 x2 x3 x5 x6 x7;
%let x5=date x1 x2 x3 x4 x6 x7;
%let x6=date x1 x2 x3 x4 x5 x7;
%let x7=date x1 x2 x3 x4 x5 x6;
