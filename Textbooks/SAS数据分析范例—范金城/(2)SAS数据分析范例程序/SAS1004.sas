%let d1=fjc.jmxfspzs0;
%let d2=fjc.jmxfspzs0;
%let d3=fjc.jmxfspzs0;
%let y1=x1;
%let y2=x2;
%let y3=x3;
%let x1=date x2 x3 y1 y2 y3 z1 z2 z3;
%let x2=date x1 x3 y1 y2 y3 z1 z2 z3;
%let x3=date x1 x3 y1 y2 y3 z1 z2 z3;
