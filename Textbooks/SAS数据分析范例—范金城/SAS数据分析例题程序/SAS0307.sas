%let d1=fjc.wenhuadws;
%let d2=fjc.wenhuadws;
%let d3=fjc.wenhuadws;
%let y1=x1;
%let y2=x2;
%let y3=x3;
...
%do i=1 %to 3;
title "&&d&i to=semiyear out=out&i";
proc expand data=&&d&i out=f&i to=semiyear;
convert x1 x2 x3 x4 x5/observed=average;
id date;
proc print data=f&i;
run;
title "&&d&i to=semiyear y=&&y&i x=&&x&i";
