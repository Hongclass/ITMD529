...
endo &&c&i;
exo t &&b&i;
x1=c0+c2*x2+c3*x3+c4*x4+c5*x5+c11*x2**2+c12*x2*x3+c22*x3**2+g1*t;
x2=b0+b1*x1+b3*x3+b4*x4+b5*x5+b11*x1**2+b13*x1*x3+b33*x3**2+h1*t;
x3=d0+d1*x1+d2*x2+d4*x4+d5*x5+d11*x1**2+d14*x1*x4+d44*x4**2+k1*t;
x4=a0+a1*x1+a2*x2+a3*x3+a5*x5+a11*x1**2+a12*x1*x2+a22*x2**2+l1*t;
x5=e0+e1*x1+e2*x2+e3*x3+e4*x4+e11*x1**2+e12*x1*x2+e22*x2**2+m1*t;
