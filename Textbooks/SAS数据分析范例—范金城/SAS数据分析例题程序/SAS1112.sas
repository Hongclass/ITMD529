...
endo &&c&i;
exo date &&b&i;
x1=c0+c2*x2+c3*x3+c4*x4+c5*x5+c6*x6+c7*x7+g1*date;
x2=b0+b1*x1+b3*x3+b4*x4+b5*x5+b6*x6+b7*x7+h1*date;
x3=d0+d1*x1+d2*x2+d4*x4+d5*x5+d6*x6+d7*x7+k1*date;
x4=a0+a1*x1+a2*x2+a3*x3+a5*x5+a6*x6+a7*x7+l1*date;
x5=e0+e1*x1+e2*x2+e3*x3+e4*x4+e6*x6+e7*x7+m1*date;
x6=f0+f1*x1+f2*x2+f3*x3+f4*x4+f5*x5+f7*x7+n1*date;
