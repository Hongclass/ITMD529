...
proc forecast data=f&i lead=&lead out=pred interval=month method=winters season=month  outfull outresid;
id date;
where date>='1jan1980'd;
var &&c&i;
run;
...
where _type_ ^= 'RESIDUAL' & date >= '1jan1988'd;
