%let d1=fjc.nlmyzzzhu0;
%let d2=fjc.nlmyzzzhu0;
%let d3=fjc.nlmyzzzhu0;
%let y1=x1;
%let y2=x2;
%let y3=x3;
%let x1=date x2 x3 x4 x5 z1 z2 z3 z4 z5;
%let x2=date x1 x3 x4 x5 z1 z2 z3 z4 z5;
%let x3=date x1 x2 x4 x5 z1 z2 z3 z4 z5;
