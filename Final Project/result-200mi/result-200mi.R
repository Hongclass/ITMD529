R.Version()
getwd()
setwd("C:/Users/Hong/Documents/text_mining")
getwd()
...
trump_tweets_loc1<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='38.9,-77,200mi')
trump_tweets_loc2<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='40.7,-74,200mi')
trump_tweets_loc3<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='37.8,-122,200mi')

trump_tweets_loc4<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='39,-105.5,200mi')
trump_tweets_loc5<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='37.4,-122,200mi')
trump_tweets_loc6<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='28,-82.5,200mi')

trump_tweets_loc7<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='30,-98,200mi')
trump_tweets_loc8<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='42.4,-71,200mi')
trump_tweets_loc9<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='48,-122,200mi')

trump_tweets_loc10<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='36,-115,200mi')
trump_tweets_loc11<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='32.3,-86.3,200mi')
trump_tweets_loc12<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='33.5,-112,200mi')

trump_tweets_loc13<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='34.7,-92.3,200mi')
trump_tweets_loc14<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='33.8,-84.4,200mi')
trump_tweets_loc15<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='37.2,-93.3,200mi')

trump_tweets_loc16<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='41.2,-104.8,200mi')
...
trump_tweets_loc19<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='37.2,-93.3,200mi')
trump_tweets_loc20<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='43,-89,200mi')
trump_tweets_loc21<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='42.7,-84.5,200mi')

trump_tweets_loc22<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='40.8,-111.8,200mi')
trump_tweets_loc23<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='36.2,-86.8,200mi')
trump_tweets_loc24<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='38.6,-92.2,200mi')

trump_tweets_loc25<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='35.8,-78.6,200mi')
trump_tweets_loc26<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='40.3,-76.8,200mi')
...
trump_tweets_loc29<- searchTwitteR('@realDonaldTrump', n = 2000,geocode='44.9,-123,200mi')
...
data_bind = rbind(trump_tweets_loc1.df,trump_tweets_loc2.df,trump_tweets_loc3.df,
             trump_tweets_loc4.df,trump_tweets_loc5.df,trump_tweets_loc6.df,
             trump_tweets_loc7.df,trump_tweets_loc8.df,trump_tweets_loc9.df,
             trump_tweets_loc10.df,trump_tweets_loc11.df,trump_tweets_loc12.df,
             trump_tweets_loc13.df,trump_tweets_loc14.df,trump_tweets_loc15.df,
             trump_tweets_loc16.df,trump_tweets_loc17.df,trump_tweets_loc18.df,
             trump_tweets_loc19.df,trump_tweets_loc20.df,trump_tweets_loc21.df,
             trump_tweets_loc22.df,trump_tweets_loc23.df,trump_tweets_loc24.df,
             trump_tweets_loc25.df,trump_tweets_loc26.df,trump_tweets_loc27.df,
             trump_tweets_loc28.df,trump_tweets_loc29.df,trump_tweets_loc30.df)
write.csv(data_bind, "data_bind.csv",row.names = F)

data=data_bind[!(is.na(data_bind$latitude) | data_bind$latitude==""), ]
write.csv(data, "data.csv",row.names = F)

lonlat=select(data,longitude,latitude)
...
write.csv(data_final, "data.csv",row.names = F)
...
score = score.sentiment(tweet, pos, neg, ter, won, pol, .progress='text')
write.csv(score, "score.csv",row.names = F)
fulltext=cbind(data,score)
write.csv(fulltext, "fulltext.csv",row.names = F)
